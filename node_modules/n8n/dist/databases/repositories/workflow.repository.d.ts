...
import { WorkflowEntity, FolderRepository } from '@n8n/db';
...
export declare class WorkflowRepository extends Repository<WorkflowEntity> {
    ...
    getMany(workflowIds: string[], options?: ListQuery.Options): Promise<(Pick<WorkflowEntity, "id"> & Partial<Pick<WorkflowEntity, "tags" | "name" | "createdAt" | "updatedAt" | "active" | "versionId">>)[]>;
    getManyAndCount(sharedWorkflowIds: string[], options?: ListQuery.Options): Promise<{
        workflows: (Pick<WorkflowEntity, "id"> & Partial<Pick<WorkflowEntity, "tags" | "name" | "createdAt" | "updatedAt" | "active" | "versionId">>)[] | ListQueryDb.Workflow.WithSharing[];
        count: number;
    }>;
