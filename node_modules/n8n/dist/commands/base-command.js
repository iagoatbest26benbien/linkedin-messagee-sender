...
class BaseCommand extends core_1.Command {
    ...
    async loadModules() {
        ...
        di_1.Container.get(module_registry_1.ModuleRegistry).initializeModules();
    ...
    async init() {
        ...
        if (constants_2.inDevelopment || constants_2.inTest) {
    ...
    async finally(error) {
        ...
        if (constants_2.inTest || this.id === 'start')
            return;
