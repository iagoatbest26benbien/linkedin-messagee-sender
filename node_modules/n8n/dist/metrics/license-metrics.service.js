...
let LicenseMetricsService = class LicenseMetricsService {
    ...
    async collectUsageMetrics() {
        const { activeWorkflows, totalWorkflows, enabledUsers, totalUsers, totalCredentials, productionExecutions, productionRootExecutions, manualExecutions, } = await this.licenseMetricsRepository.getLicenseRenewalMetrics();
...
exports.LicenseMetricsService = LicenseMetricsService = __decorate([
    (0, di_1.Service)(),
    __metadata("design:paramtypes", [db_1.LicenseMetricsRepository,
