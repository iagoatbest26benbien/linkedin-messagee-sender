...
let ExecutionsPruningService = class ExecutionsPruningService {
    constructor(logger, instanceSettings, executionRepository, binaryDataService, executionsConfig) {
        this.logger = logger;
    ...
    startPruning() {
        if (!this.isEnabled || !db_2.connectionState.migrated || this.isShuttingDown)
            return;
